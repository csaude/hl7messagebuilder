...
public class Hl7messagebuilderDao implements Hl7messagebuilderDAO {
	...
	public List<PatientDemographic> getPatientDemographicData() {
		...
		String sql = "select 	distinct(pid.identifier) pid,"
		        ...
		        + "		END marital_status," + "		e3.encounter_datetime lastconsultation" + " from" + " person pe "
		...
		for (Object[] o : objs) {
			...
			String lastConsultation = aux[13] == null ? "01" : new SimpleDateFormat("yyyyMMdd").format((Date) aux[13]);
